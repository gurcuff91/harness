...
// of a live FileStore instance can agree on the same default without
// duplicating it.
...
// for a purpose FileStore itself doesn't cover can compute the identical
// path without duplicating the slugging rules.
