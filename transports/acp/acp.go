...
// WithStdin sets the stream ACP JSON-RPC requests are read from. Default:
// os.Stdin — only worth overriding for embedding/test scenarios that don't
// want the real process stream.
func WithStdin(r io.Reader) Option {
	return func(c *runConfig) { c.stdin = r }
}

// WithStdout sets the stream ACP JSON-RPC responses/notifications are
// written to. Default: os.Stdout.
